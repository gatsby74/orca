...
export const PRIVACY_PANE_SEARCH_ENTRIES: SettingsSearchEntry[] = [
  ...
  },
  {
    ...
    keywords: [translate("auto.components.settings.privacy.search.77d3180def", "telemetry"), translate("auto.components.settings.privacy.search.79c319948b", "usage"), translate("auto.components.settings.privacy.search.b021b9cb81", "anonymous"), translate("auto.components.settings.privacy.search.4d4bb76bf4", "opt in"), translate("auto.components.settings.privacy.search.27a27b2f63", "opt out"), translate("auto.components.settings.privacy.search.ead1deded2", "share")]
  },
  {
    title: translate("auto.components.settings.privacy.search.6d258d2ed6", "Diagnostics"),
    description: translate("auto.components.settings.privacy.search.8b08f32366", "Trace files and OTLP export controls."),
    keywords: [translate("auto.components.settings.privacy.search.c0494ff48a", "diagnostics"), translate("auto.components.settings.privacy.search.40de3c2f19", "trace"), translate("auto.components.settings.privacy.search.685c68a81f", "logs"), translate("auto.components.settings.privacy.search.9ea93ce3d6", "otlp"), translate("auto.components.settings.privacy.search.4a583f3a2f", "opentelemetry"), translate("auto.components.settings.privacy.search.1686c07fee", "support")]
  },
  {
