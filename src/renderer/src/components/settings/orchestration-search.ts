...
export const ORCHESTRATION_PANE_SEARCH_ENTRIES: SettingsSearchEntry[] = [
  {
    ...
    description:
      translate("auto.components.settings.orchestration.search.e05ff36753", "Coordinate multiple coding agents via messaging, task DAGs, dispatch, and decision gates."),
    keywords: [
