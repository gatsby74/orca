...
export const QUICK_COMMANDS_PANE_SEARCH_ENTRIES: SettingsSearchEntry[] = [
  {
    ...
    description:
      translate("auto.components.settings.quick.commands.search.d691c4e8d8", "Saved terminal commands that can be launched from any terminal, scoped globally or to a specific project."),
    keywords: [
