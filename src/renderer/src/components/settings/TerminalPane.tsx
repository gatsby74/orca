  ...
  const visibleSections = [
    ...
    matchesSettingsSearch(searchQuery, TERMINAL_WINDOWS_SHELL_SEARCH_ENTRY) ? (
      <section key="windows-shell" className="space-y-3">
        <SettingsSubsectionHeader
          ...
          description={translate("auto.components.settings.TerminalPane.a55eee649f", "Default shell for new terminal panes on Windows.")}
        />

        <div className="divide-y divide-border/40">
          <SearchableSetting
            title={translate("auto.components.settings.TerminalPane.27e301f22c", "Default Shell")}
            description={translate("auto.components.settings.TerminalPane.bd68f3170d", "Choose the default shell for new terminal panes on Windows.")}
            keywords={[
              'terminal',
              'windows',
              'shell',
          ...
          >
            <SettingsRow
              ...
              description={translate("auto.components.settings.TerminalPane.09bf02de9a", "Shell used when opening a new terminal pane. Takes effect for new terminals.")}
              control={
                <SettingsSegmentedControl
                  ariaLabel={translate("auto.components.settings.TerminalPane.27e301f22c", "Default Shell")}
                  value={windowsShell}
                  onChange={(value) => updateSettings({ terminalWindowsShell: value })}
                  options={[
                    { value: 'powershell.exe', label: translate("auto.components.settings.TerminalPane.eb7fc4d98a", "PowerShell") },
                    { value: 'cmd.exe', label: translate("auto.components.settings.TerminalPane.0f1b8669e6", "Command Prompt") },
                    ...(showGitBashOption
                      ? [
                          {
                            value: WINDOWS_GIT_BASH_SHELL,
                            label: translate("auto.components.settings.TerminalPane.f61ac77f16", "Git Bash"),
                            disabled: !gitBashAvailable
                          }
                        ]
                      : []),
                    ...(wslAvailable ? [{ value: 'wsl.exe', label: translate("auto.components.settings.TerminalPane.b637dd57a7", "WSL") }] : [])
                  ]}
                />
              }
            />
          ...
          {windowsShell === "wsl.exe" ? (
            ...
            >
              <SettingsRow
                label={translate("auto.components.settings.TerminalPane.219aaa59f4", "WSL Distribution")}
                description={translate("auto.components.settings.TerminalPane.2503f1e86b", "Used for new WSL terminal panes and local agent detection when the active workspace is not already inside WSL.")}
                control={
                  <Select
                  ...
                  >
                    <SelectTrigger size="sm" aria-label={translate("auto.components.settings.TerminalPane.219aaa59f4", "WSL Distribution")} className="min-w-44">
                      <SelectValue
                        placeholder={
                          wslCapabilitiesLoading ? translate("auto.components.settings.TerminalPane.d78fc4fdef", "Loading distributions") : translate("auto.components.settings.TerminalPane.cc8c5ca224", "Windows default")
                        }
                      />
                    </SelectTrigger>
                    <SelectContent>
                      <SelectItem value="__default__">{translate("auto.components.settings.TerminalPane.cc8c5ca224", "Windows default")}</SelectItem>
    ...
    matchesSettingsSearch(searchQuery, TERMINAL_RENDERING_SEARCH_ENTRIES) ? (
      <section key="rendering" className="space-y-3">
        <SettingsSubsectionHeader
          ...
          description={translate("auto.components.settings.TerminalPane.72bc9334a0", "Terminal renderer behavior for live panes and new panes.")}
        />

        <div className="divide-y divide-border/40">
          <SearchableSetting
            title={translate("auto.components.settings.TerminalPane.c1fc9e9444", "GPU Acceleration")}
            description={translate("auto.components.settings.TerminalPane.f07dfb4466", "Controls whether the terminal uses xterm.js WebGL rendering. Auto tries WebGL when the renderer is supported, with a conservative Linux fallback for software or unknown GPU renderers.")}
            keywords={[
              'terminal',
              'gpu',
              'acceleration',
          ...
          >
            <SettingsRow
              ...
              control={
                <SettingsSegmentedControl
                  ariaLabel={translate("auto.components.settings.TerminalPane.c1fc9e9444", "GPU Acceleration")}
                  value={settings.terminalGpuAcceleration ?? 'auto'}
                  onChange={(option) => updateSettings({ terminalGpuAcceleration: option })}
                  options={[
                    { value: 'auto', label: translate("auto.components.settings.TerminalPane.43c2ff7b0e", "Auto") },
                    { value: 'on', label: translate("auto.components.settings.TerminalPane.9c0b1c1792", "On") },
                    { value: 'off', label: translate("auto.components.settings.TerminalPane.3fe1c5bfe0", "Off") }
                  ]}
                />
              }
            />
    ...
    (isWindows &&
      ...
      <section key="pane-interaction" className="space-y-3">
        <SettingsSubsectionHeader
          ...
          description={translate("auto.components.settings.TerminalPane.96fe15def8", "Mouse and clipboard behavior for terminal panes.")}
        />
        ...
        <div className="divide-y divide-border/40">
          ...
          <SearchableSetting
            ...
            description={translate("auto.components.settings.TerminalPane.9129b7e805", "Hovering a terminal pane activates it without needing to click.")}
            keywords={['focus', 'follows', 'mouse', 'hover', 'pane', 'ghostty', 'active']}
          >
            <SettingsSwitchRow
              label={translate("auto.components.settings.TerminalPane.8eefeaa3da", "Focus Follows Mouse")}
              description={translate("auto.components.settings.TerminalPane.9129b7e805", "Hovering a terminal pane activates it without needing to click.")}
          ...
          <SearchableSetting
            ...
            description={translate("auto.components.settings.TerminalPane.4729c645fc", "Automatically copy terminal selections to the clipboard.")}
            keywords={[
              'clipboard',
              'copy',
              'select',
          ...
          <SearchableSetting
            ...
            title={translate("auto.components.settings.TerminalPane.3338dcf8c1", "Allow TUI Clipboard Writes (OSC 52)")}
            description={translate("auto.components.settings.TerminalPane.69c64a479c", "Let tmux, Neovim, and fzf copy to the system clipboard over the PTY (including over SSH).")}
            keywords={[
              'osc 52',
              'osc52',
              'clipboard',
          ...
          >
            <SettingsSwitchRow
              label={translate("auto.components.settings.TerminalPane.3338dcf8c1", "Allow TUI Clipboard Writes (OSC 52)")}
              description={translate("auto.components.settings.TerminalPane.6e6480a7df", "Let programs in the terminal (tmux, Neovim, fzf, SSH) copy to your system clipboard.")}
    ...
    matchesSettingsSearch(searchQuery, TERMINAL_SETUP_SCRIPT_SEARCH_ENTRIES) ? (
      <section key="setup-script" className="space-y-3">
        <SettingsSubsectionHeader
          title={translate("auto.components.settings.TerminalPane.21f8da2078", "Workspace Setup Script")}
          description={translate("auto.components.settings.TerminalPane.34a0dfa06e", "Where the repository setup script runs when a new workspace is created.")}
        />

        <div className="divide-y divide-border/40">
          <SearchableSetting
            title={translate("auto.components.settings.TerminalPane.d23b43c5be", "Setup Script Location")}
            description={translate("auto.components.settings.TerminalPane.34a0dfa06e", "Where the repository setup script runs when a new workspace is created.")}
            keywords={[
              'setup',
              'script',
          ...
          >
            <SettingsRow
              label={translate("auto.components.settings.TerminalPane.d23b43c5be", "Setup Script Location")}
              description={translate("auto.components.settings.TerminalPane.a9d47451d1", "\"New Tab\" opens the setup command in a background tab titled \"Setup\" without stealing focus.")}
              control={
                <ToggleGroup
                  type="single"
                ...
                >
                  <ToggleGroupItem
                    ...
                    aria-label={translate("auto.components.settings.TerminalPane.6c6a054a1c", "Run in a new tab")}
                  >
                    {translate("auto.components.settings.TerminalPane.1158f8fd55", "New Tab")}</ToggleGroupItem>
                  <ToggleGroupItem
                    value="split-vertical"
                    className="h-8 px-3 text-xs"
                    aria-label={translate("auto.components.settings.TerminalPane.691ce810e0", "Split vertically")}
                  >
                    {translate("auto.components.settings.TerminalPane.332e8a2872", "Split Vertically")}</ToggleGroupItem>
                  <ToggleGroupItem
                    value="split-horizontal"
                    className="h-8 px-3 text-xs"
                    aria-label={translate("auto.components.settings.TerminalPane.623e62df99", "Split horizontally")}
                  >
                    {translate("auto.components.settings.TerminalPane.003df129fe", "Split Horizontally")}</ToggleGroupItem>
                </ToggleGroup>
              }
            />
          </SearchableSetting>
    ...
    (isMac &&
      ...
      <section key="advanced" className="space-y-3">
        <SettingsSubsectionHeader
          ...
          description={translate("auto.components.settings.TerminalPane.267d020745", "Scrollback, word boundaries, and platform-specific terminal behaviors.")}
        />

        <div className="divide-y divide-border/40">
          <SearchableSetting
            title={translate("auto.components.settings.TerminalPane.9df53f7c14", "Scrollback Size")}
            description={translate("auto.components.settings.TerminalPane.c3810b2b42", "Maximum terminal scrollback buffer size.")}
          ...
          >
            <SettingsRow
              ...
              description={translate("auto.components.settings.TerminalPane.81d86b2dd2", "Maximum terminal scrollback buffer size for new terminal panes.")}
              control={
                <div className="flex flex-col items-end gap-2">
                  ...
                  >
                    {SCROLLBACK_PRESETS_MB.map((preset) => (
                      <ToggleGroupItem
                        ...
                        value={`${preset}`}
                        className="h-8 px-3 text-xs"
                        aria-label={translate("auto.components.settings.TerminalPane.5336c096af", "{{value0}} megabytes", { value0: preset })}
                      >
                        {preset} {translate("auto.components.settings.TerminalPane.12e06178fa", "MB")}</ToggleGroupItem>
                    ))}
                    <ToggleGroupItem
                      value="custom"
                      className="h-8 px-3 text-xs"
                      aria-label={translate("auto.components.settings.TerminalPane.907b0b9d3e", "Custom")}
                    >
                  ...
                  {scrollbackMode === "custom" ? (
                    <div className="flex items-center gap-2">
                      ...
                      />
                      <span className="text-xs text-muted-foreground">{translate("auto.components.settings.TerminalPane.12e06178fa", "MB")}</span>
                    </div>
                  ) : null}
                </div>
              }
          ...
          <SearchableSetting
            ...
            description={translate("auto.components.settings.TerminalPane.8a956cc91e", "Characters treated as word boundaries for double-click selection.")}
          ...
          matchesSettingsSearch(
            ...
            <SearchableSetting
              title={translate("auto.components.settings.TerminalPane.fe20f79dd1", "PowerShell Version")}
              description={translate("auto.components.settings.TerminalPane.3d88af864d", "Choose whether the PowerShell shell option launches Windows PowerShell or PowerShell 7+ for new terminal panes.")}
              keywords={[
                'terminal',
                'windows',
                'powershell',
            ...
            >
              <SettingsRow
                alignTop
                label={translate("auto.components.settings.TerminalPane.fe20f79dd1", "PowerShell Version")}
                description={
                  pwshAvailable ? (
                    translate(
                    ...
                    <>
                      {translate("auto.components.settings.TerminalPane.a016ffbeed", "Auto uses Windows PowerShell now and switches to PowerShell 7+ when installed.")}{' '}
                      <a
                      ...
                      >
                        {translate("auto.components.settings.TerminalPane.822f62ddcd", "Download PowerShell 7+")}</a>
                      .
                    </>
                  )
                }
                control={
                  <SettingsSegmentedControl
                    ariaLabel={translate("auto.components.settings.TerminalPane.fe20f79dd1", "PowerShell Version")}
                    ...
                    options={[
                      { value: 'auto', label: translate("auto.components.settings.TerminalPane.43c2ff7b0e", "Auto") },
                      { value: 'powershell.exe', label: translate("auto.components.settings.TerminalPane.d26174e1dd", "Windows PowerShell") },
                      { value: 'pwsh.exe', label: translate("auto.components.settings.TerminalPane.96be03b8eb", "PowerShell 7+"), disabled: !pwshAvailable }
                    ]}
                  />
                }
              />
          ...
          {isMac ? (
            <>
              <SearchableSetting
                ...
                description={translate("auto.components.settings.TerminalPane.2561d3fc1b", "Controls whether the macOS Option key sends Alt/Esc sequences or composes characters.")}
                keywords={[
                  'terminal',
                  'option',
                  'alt',
              ...
              >
                <SettingsRow
                  ...
                  control={
                    <SettingsSegmentedControl
                      ariaLabel={translate("auto.components.settings.TerminalPane.0a10420e1a", "Option as Alt")}
                      value={settings.terminalMacOptionAsAlt}
                      onChange={(option) => updateSettings({ terminalMacOptionAsAlt: option })}
                      options={[
                        { value: 'auto', label: translate("auto.components.settings.TerminalPane.43c2ff7b0e", "Auto") },
                        { value: 'true', label: translate("auto.components.settings.TerminalPane.badb1219fc", "Both") },
                        { value: 'left', label: translate("auto.components.settings.TerminalPane.e7aec1fd60", "Left") },
                        { value: 'right', label: translate("auto.components.settings.TerminalPane.c73d510938", "Right") },
                        { value: 'false', label: translate("auto.components.settings.TerminalPane.3fe1c5bfe0", "Off") }
                      ]}
                    />
                  }
                />
              ...
              <SearchableSetting
                title={translate("auto.components.settings.TerminalPane.19f4935159", "JIS Yen (¥) to Backslash (\\\\)")}
                description={translate("auto.components.settings.TerminalPane.1c337bef4a", "Controls whether pressing the JIS Yen (¥) key sends a backslash (\\\\) instead.")}
                keywords={[
                  'terminal',
                  'yen',
                  'backslash',
              ...
              >
                <SettingsSwitchRow
                  label={translate("auto.components.settings.TerminalPane.19f4935159", "JIS Yen (¥) to Backslash (\\\\)")}
                  description={translate("auto.components.settings.TerminalPane.4263e940e0", "Pressing the JIS Yen (¥) key sends a backslash (\\\\) instead.")}
