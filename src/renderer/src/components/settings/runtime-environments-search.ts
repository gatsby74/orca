...
export const RUNTIME_ENVIRONMENTS_SEARCH_ENTRY: SettingsSearchEntry = {
  title: translate("auto.components.settings.runtime.environments.search.3517fb2ec0", "Active Server"),
  description: translate("auto.components.settings.runtime.environments.search.4575341c77", "Choose local desktop, add a saved remote Orca server, or generate a pairing URL."),
  keywords: [
...
export const WEB_RUNTIME_ENVIRONMENTS_SEARCH_ENTRY: SettingsSearchEntry = {
  ...
  keywords: [translate("auto.components.settings.runtime.environments.search.d198440ce3", "runtime"), translate("auto.components.settings.runtime.environments.search.ebd5369acf", "environment"), translate("auto.components.settings.runtime.environments.search.09568ccc65", "server"), translate("auto.components.settings.runtime.environments.search.d760866285", "client"), translate("auto.components.settings.runtime.environments.search.5cd7dca3b8", "remote"), translate("auto.components.settings.runtime.environments.search.2bd988d041", "pairing code"), translate("auto.components.settings.runtime.environments.search.45501ff2c3", "cloud"), translate("auto.components.settings.runtime.environments.search.772e3b4753", "vm")]
}
