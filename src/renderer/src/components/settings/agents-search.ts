...
export const AGENTS_PANE_SEARCH_ENTRIES: SettingsSearchEntry[] = [
  ...
  },
  {
    ...
    description: translate("auto.components.settings.agents.search.cbdd7f3b9e", "Choose whether installed agents are detected on this device or in WSL."),
    keywords: [translate("auto.components.settings.agents.search.96ba2373b6", "agent"), translate("auto.components.settings.agents.search.d2952dfd74", "location"), translate("auto.components.settings.agents.search.77c02fa3c3", "windows"), translate("auto.components.settings.agents.search.d608654c03", "wsl"), translate("auto.components.settings.agents.search.f622b8eb2a", "linux"), translate("auto.components.settings.agents.search.839e82c81f", "detect"), translate("auto.components.settings.agents.search.2814401339", "installed"), translate("auto.components.settings.agents.search.719f53350c", "path")]
  },
  {
