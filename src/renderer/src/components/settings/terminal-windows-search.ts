...
export const TERMINAL_WINDOWS_POWERSHELL_IMPLEMENTATION_SEARCH_ENTRY: SettingsSearchEntry[] = [
  {
    ...
    description:
      translate("auto.components.settings.terminal.windows.search.41a69bc24d", "Choose whether the PowerShell shell option launches Windows PowerShell or PowerShell 7+ for new terminal panes."),
    keywords: [
      translate("auto.components.settings.terminal.windows.search.e7d2793b03", "terminal"),
      translate("auto.components.settings.terminal.windows.search.28ff08ed35", "windows"),
      translate("auto.components.settings.terminal.windows.search.2d99cd91be", "powershell"),
...
export const TERMINAL_WINDOWS_WSL_DISTRO_SEARCH_ENTRY: SettingsSearchEntry[] = [
  {
    title: translate("auto.components.settings.terminal.windows.search.1f402b3651", "WSL Distribution"),
    description: translate("auto.components.settings.terminal.windows.search.978457945b", "Choose which WSL distribution new WSL terminals and local agent scans use."),
    keywords: [
      translate("auto.components.settings.terminal.windows.search.e7d2793b03", "terminal"),
      translate("auto.components.settings.terminal.windows.search.28ff08ed35", "windows"),
      translate("auto.components.settings.terminal.windows.search.6e3adf4cba", "wsl"),
...
export const TERMINAL_RIGHT_CLICK_TO_PASTE_SEARCH_ENTRY: SettingsSearchEntry[] = [
  {
    ...
    description:
      translate("auto.components.settings.terminal.windows.search.8ba875c132", "On Windows, right-click pastes the clipboard into the terminal. Use Ctrl+right-click to open the context menu."),
    keywords: [translate("auto.components.settings.terminal.windows.search.e7d2793b03", "terminal"), translate("auto.components.settings.terminal.windows.search.28ff08ed35", "windows"), translate("auto.components.settings.terminal.windows.search.e55186fe2b", "right click"), translate("auto.components.settings.terminal.windows.search.fcfa53920b", "paste"), translate("auto.components.settings.terminal.windows.search.4d09141a42", "context menu")]
  }
]
