  ...
  return [
    {
      ...
      keywords: [translate("auto.components.settings.browser.search.2d2d995c58", "browser"), translate("auto.components.settings.browser.search.291f480a5e", "home"), translate("auto.components.settings.browser.search.0dbb1eaf4e", "homepage"), translate("auto.components.settings.browser.search.5448f4097b", "default"), translate("auto.components.settings.browser.search.4fda4fb066", "url"), translate("auto.components.settings.browser.search.483a0eb5e0", "new tab"), translate("auto.components.settings.browser.search.5164c47e31", "blank"), translate("auto.components.settings.browser.search.4596a52cf7", "landing")]
    },
    {
    ...
    },
    {
      ...
      keywords: [translate("auto.components.settings.browser.search.2d2d995c58", "browser"), translate("auto.components.settings.browser.search.4a98ed195f", "zoom"), translate("auto.components.settings.browser.search.54f4ea55f7", "scale"), translate("auto.components.settings.browser.search.5448f4097b", "default"), translate("auto.components.settings.browser.search.726f2a8556", "page zoom"), translate("auto.components.settings.browser.search.483a0eb5e0", "new tab"), translate("auto.components.settings.browser.search.95944898e0", "percentage")]
    },
    {
    ...
    },
    {
      ...
      description:
        translate("auto.components.settings.browser.search.060ac1fcba", "Import cookies from Chrome, Edge, or other browsers to use existing logins inside Orca."),
      keywords: [
        translate("auto.components.settings.browser.search.2d2d995c58", "browser"),
