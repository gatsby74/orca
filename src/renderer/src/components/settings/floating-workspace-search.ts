...
export const FLOATING_WORKSPACE_SEARCH_ENTRIES: SettingsSearchEntry[] = [
  {
    ...
    description:
      translate("auto.components.settings.floating.workspace.search.b96b5ee6cf", "Enable the floating workspace, choose where new tabs start, and choose where the toggle button appears."),
    keywords: [
