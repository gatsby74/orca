...
export const EXPERIMENTAL_PANE_SEARCH_ENTRIES: SettingsSearchEntry[] = [
  ...
  {
    title: translate("auto.components.settings.experimental.search.78c2a8dc74", "Symlinks on worktrees"),
    description:
      translate("auto.components.settings.experimental.search.603d29ed74", "Automatically symlink configured files or folders into newly created worktrees so shared state (envs, caches, installs) stays connected."),
    keywords: [
      translate("auto.components.settings.experimental.search.0d24759f14", "experimental"),
