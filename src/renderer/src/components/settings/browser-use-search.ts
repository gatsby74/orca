...
export const BROWSER_USE_PANE_SEARCH_ENTRIES: SettingsSearchEntry[] = [
  {
    ...
    keywords: [translate("auto.components.settings.browser.use.search.ba4eb53b72", "browser use"), translate("auto.components.settings.browser.use.search.85fab5e12c", "cli"), translate("auto.components.settings.browser.use.search.ff05cbc344", "orca"), translate("auto.components.settings.browser.use.search.30c74aaa1f", "path"), translate("auto.components.settings.browser.use.search.3ffafc9b95", "command"), translate("auto.components.settings.browser.use.search.7e0dcb257a", "shell"), translate("auto.components.settings.browser.use.search.034c5e8d7f", "enable"), translate("auto.components.settings.browser.use.search.e56c7b55c9", "setup")]
  },
  {
  ...
  },
  {
    ...
    description:
      translate("auto.components.settings.browser.use.search.2fb24d17db", "Import cookies from Chrome, Edge, or other browsers so agents can reuse your logins."),
    keywords: [
      translate("auto.components.settings.browser.use.search.ba4eb53b72", "browser use"),
