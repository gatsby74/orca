...
export const MOBILE_PANE_SEARCH_ENTRIES: SettingsSearchEntry[] = [
  {
    ...
    keywords: [translate("auto.components.settings.mobile.pane.search.6db86f445f", "mobile"), translate("auto.components.settings.mobile.pane.search.3c1807a81a", "qr"), translate("auto.components.settings.mobile.pane.search.4a0c826f3d", "code"), translate("auto.components.settings.mobile.pane.search.e518cbd61c", "pair"), translate("auto.components.settings.mobile.pane.search.ad08035c5f", "phone"), translate("auto.components.settings.mobile.pane.search.2128a21096", "scan")]
  },
  {
    ...
    keywords: [translate("auto.components.settings.mobile.pane.search.6db86f445f", "mobile"), translate("auto.components.settings.mobile.pane.search.82783d9b71", "devices"), translate("auto.components.settings.mobile.pane.search.905c65a308", "revoke"), translate("auto.components.settings.mobile.pane.search.5e8fda4d7f", "paired"), translate("auto.components.settings.mobile.pane.search.7d01f93ec0", "connected")]
  },
  {
  ...
  },
  {
    ...
    description:
      translate("auto.components.settings.mobile.pane.search.707fc78052", "Choose what happens to terminals you were viewing on mobile after you close the app or switch away."),
    keywords: [
