...
export const TERMINAL_CLIPBOARD_SEARCH_ENTRIES: SettingsSearchEntry[] = [
  {
    ...
    description:
      translate("auto.components.settings.terminal.clipboard.search.603818e8d8", "Automatically copy terminal selections to the clipboard as soon as a selection is made."),
    keywords: [
  ...
  },
  {
    ...
    description:
      translate("auto.components.settings.terminal.clipboard.search.459fea094a", "Let programs in the terminal copy to the system clipboard through OSC 52, including over SSH."),
    keywords: [
