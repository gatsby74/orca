...
export const COMMIT_MESSAGE_AI_PANE_SEARCH_ENTRIES: SettingsSearchEntry[] = [
  {
    ...
    description:
      translate("auto.components.settings.commit.message.ai.search.0b946b2abe", "Adds action recipes for Source Control commit, pull request, branch-name, and fix actions."),
    keywords: [
  ...
  },
  {
    ...
    description:
      translate("auto.components.settings.commit.message.ai.search.18b6d38835", "Agent, CLI arguments, and command template used by each Source Control AI button."),
    keywords: [
      translate("auto.components.settings.commit.message.ai.search.3766941527", "agent"),
  ...
  },
  {
    ...
    keywords: [translate("auto.components.settings.commit.message.ai.search.110be48b81", "pull request"), translate("auto.components.settings.commit.message.ai.search.b261c88609", "pr"), translate("auto.components.settings.commit.message.ai.search.7e264b926b", "draft"), translate("auto.components.settings.commit.message.ai.search.b7d50da4d8", "template"), translate("auto.components.settings.commit.message.ai.search.8e9cc598d7", "generate"), translate("auto.components.settings.commit.message.ai.search.181cdb0637", "open")]
  }
]
