...
export const STATS_PANE_SEARCH_ENTRIES: SettingsSearchEntry[] = [
  {
    ...
    description:
      translate("auto.components.stats.stats.search.26bb901fcd", "Orca stats plus combined Claude, Codex, and OpenCode usage analytics, tokens, cache, models, and sessions."),
    keywords: [
