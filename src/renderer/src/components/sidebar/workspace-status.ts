...
const FALLBACK_COLOR_OPTION: WorkspaceStatusColorOption = getWorkspaceStatusColorOptions()[0] ?? {
...
const FALLBACK_ICON_OPTION: WorkspaceStatusIconOption = getWorkspaceStatusIconOptions()[1] ?? {
